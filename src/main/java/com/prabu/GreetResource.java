...
public class GreetResource {
    ...
    public JsonObject getDefaultMessage() {
        return createResponse("Hello My Microprofile World !!!");
    }
  ...
  //when calling GET name
    ...
    @RequestBody(name = "greeting",
            ...
            content = @Content(mediaType = "application/json",
                    schema = @Schema(type = SchemaType.STRING, example = "{\"greeting\" : \"Prabu\"}")))
    @APIResponses({
    ...
    //create sample jsonObject Response
